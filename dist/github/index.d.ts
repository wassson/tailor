export declare const pullRequestDiff: (number: string) => Promise<import("@octokit/types").OctokitResponse<any, number>>;
export declare const pushDescription: (number: string, description: string) => Promise<import("@octokit/types").OctokitResponse<{
    url: string;
    id: number;
    node_id: string;
    html_url: string;
